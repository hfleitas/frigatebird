...
ADX_TABLE ='SecureConfigurationsAssessmentByMachineIngest'  #'IncidentIngest'
...
response = requests.get("https://api.securitycenter.microsoft.com/api/machines/SecureConfigurationsAssessmentByMachine", headers=headers)
#print(response)
